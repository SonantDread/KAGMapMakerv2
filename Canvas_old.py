import sys
from PyQt5.QtWidgets import QApplication, QGraphicsView, QGraphicsScene, QGraphicsRectItem, QGraphicsPixmapItem, QGraphicsItem, QMenu, QAction, QMainWindow, QVBoxLayout, QWidget
...
class Canvas(QGraphicsView):
    ...
    def mouseReleaseEvent(self, event):
        pass # todo: implement this to enable drawing with current item as you move the mouse

    def mousePressEvent(self, event):
        # todo: check if this is lmb + !lmb = eraser
    ...
    def keyPressEvent(self, event):
        ...
        if event.key() == Qt.Key_F:
            pass # TODO: make this open a block selection menu, with tab 1 being blocks and tab 2 being entities. (maybe just one tab?)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Canvas with Grid Example")
